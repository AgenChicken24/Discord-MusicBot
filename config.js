     ...
     nodes: [
          {
               ...
               host: process.env.LAVALING_HOST || "lavalink.rukchadisa.live", //- The host name or IP of the lavalink server.
               port: +process.env.LAVALING_PORT || 8080, // The port that lavalink is listening to. This must be a number!
               password: process.env.LAVALING_PASS || "youshallnotpass", //- The password of the lavalink server.
